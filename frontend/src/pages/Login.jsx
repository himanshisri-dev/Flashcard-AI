...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-animated flex items-center justify-center px-4">
      {/* Decorative blobs */}
      <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-indigo-400/20 dark:bg-indigo-600/20 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-400/15 dark:bg-purple-600/15 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Sign in to FlashCard AI</p>
        </div>
